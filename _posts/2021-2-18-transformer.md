...
| Fig 2. Illustration of the ``Multi-Head Attention`` block [[2]](#ref2). |
...
| Fig 3. The softmax of the scaled dot-product scores [[2]](#ref2). |
...
| Fig 4. The masking process in the self-attention layers of the decoder *up to some time step $$t$$* [[2]](#ref2). |
