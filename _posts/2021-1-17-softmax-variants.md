...
which means the sample average converges **almost surely** (see the detailed defintion [here](https://www.statlect.com/asymptotic-theory/almost-sure-convergence)) to the mean. Briefly speaking, 
